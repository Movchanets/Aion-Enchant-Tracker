...
const DICT: Dict = {
  ...
  supplement: { uk: 'Суплемент', en: 'Supplement' },
  supplementNone: { uk: 'Без суплемента', en: 'None' },
  supplementLesser: { uk: 'Малий (+5%)', en: 'Lesser (+5%)' },
  supplementRegular: { uk: 'Звичайний (+10%)', en: 'Regular (+10%)' },
  supplementGreater: { uk: 'Великий (+15%)', en: 'Greater (+15%)' },
  supplementBonusHint: { uk: 'Бонус суплемента', en: 'Supplement bonus' },
